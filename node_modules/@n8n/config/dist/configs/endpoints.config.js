...
let PrometheusMetricsConfig = class PrometheusMetricsConfig {
    constructor() {
        ...
        this.includeWorkflowExecutionDuration = true;
        this.includeWorkflowStatistics = false;
        this.workflowStatisticsInterval = 300;
    }
};
__decorate([
...
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_WORKFLOW_EXECUTION_DURATION'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeWorkflowExecutionDuration", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_WORKFLOW_STATISTICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeWorkflowStatistics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_WORKFLOW_STATISTICS_INTERVAL'),
    __metadata("design:type", Number)
], PrometheusMetricsConfig.prototype, "workflowStatisticsInterval", void 0);
...
__decorate([
    (0, decorators_1.Env)('N8N_MCP_BUILDER_ENABLED'),
    __metadata("design:type", Boolean)
], EndpointsConfig.prototype, "mcpBuilderEnabled", void 0);
__decorate([
...
__decorate([
    (0, decorators_1.Env)('N8N_ENDPOINT_HEALTH', zod_1.z.string().transform((val) => (val.startsWith('/') ? val : `/${val}`))),
    __metadata("design:type", String)
], EndpointsConfig.prototype, "health", void 0);
